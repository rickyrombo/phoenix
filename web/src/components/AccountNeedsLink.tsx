...
export function AccountNeedsLink() {
  const { login } = useAuth()
  ...
  return (
    <Flex direction="column">
      <p>
        The connected wallet isn't associated with an existing Audius account.
      </p>
      <p>Do you want to create a new account with this wallet?</p>
      <Flex justifyContent="space-between" fullWidth>
        <Button size="l" variant="primary" onClick={createNewAccount}>
          Create New Account
        </Button>
        <Button onClick={linkExistingAccount}>Link to Existing Account</Button>
      </Flex>
    </Flex>
  )
}
